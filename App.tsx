          ...
          {isAuthLoading ? (
            ...
            <>
              <button
                ...
                className="group relative flex items-center gap-2 px-4 py-1.5 rounded-full bg-gray-100 border border-gray-200 text-gray-600 shadow-sm cursor-pointer overflow-hidden transition-all duration-300 hover:bg-gradient-to-br hover:from-gray-300 hover:via-gray-400 hover:to-gray-500 hover:text-white hover:border-transparent hover:shadow-[0_0_20px_rgba(255,255,255,0.7)]"
              >
                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" className="text-gray-500 transition-all duration-300 group-hover:text-white group-hover:drop-shadow-[0_0_6px_rgba(255,255,255,0.6)]">
                  <path d="M12 2L14.4 9.6L22 12L14.4 14.4L12 22L9.6 14.4L2 12L9.6 9.6L12 2Z"></path>
                </svg>
                <span className="tracking-wide font-semibold text-current">
                  {isCreditsLoading ? '--' : (userCredits ?? 0)} <span className="text-gray-500 font-medium ml-0.5 group-hover:text-white/90">Tokens</span>
                </span>
              </button>
      ...
      <main className="relative z-30 w-full max-w-6xl px-4 md:px-6 pt-24 pb-12 md:py-32 flex flex-col items-center overflow-x-hidden font-sans antialiased text-gray-900">
        {step === 'upload' ? (
          <div className="w-full space-y-12 reveal-up">
            ...
            <div className="relative w-full bg-[#f5f5f7] pb-24 mt-8">
               <div
               ...
               >
                 <div className="absolute inset-0 w-full h-full z-0 pointer-events-none overflow-hidden">
                   <div className="absolute inset-0 bg-gradient-to-tr from-gray-100 via-gray-200 to-gray-50 w-full h-full opacity-80"></div>
                 </div>
               </div>
               <div className="relative z-10 max-w-4xl mx-auto flex flex-col">
                ...
                <section ref={posterRef} className={`order-5 bg-white rounded-[2rem] p-8 md:p-10 mb-8 mx-auto max-w-4xl border border-white/60 shadow-[0_20px_60px_rgba(0,0,0,0.03)] transition-shadow duration-500 hover:shadow-[0_30px_80px_rgba(0,0,0,0.06)] apple-reveal-base ${isPosterVisible ? 'apple-reveal-visible' : 'apple-reveal-hidden'}`}>
                  ...
                  <div className="space-y-5 bg-white/60 backdrop-blur-2xl border border-white/40 shadow-[0_8px_32px_rgba(0,0,0,0.04)] rounded-[2rem] p-8 md:p-10 relative overflow-hidden z-20">
                    <div className={`copy-editor-card copy-editor-card--title ${highlightCopy ? "copy-editor-card--highlight" : ""}`}>
                      ...
                      <textarea
                        ...
                        onChange={e => setTextConfig({...textConfig, title: e.target.value})}
                        rows={2}
                        className="w-full bg-gray-50/50 hover:bg-gray-100/50 focus:bg-white focus:ring-2 focus:ring-[#1d1d1f]/10 border-none rounded-2xl px-6 py-4 min-h-[84px] resize-none text-base text-[#1d1d1f] transition-all duration-300 placeholder:text-gray-400 focus:outline-none"
                      />
                    </div>
                    <div className={`copy-editor-card copy-editor-card--detail ${highlightCopy ? "copy-editor-card--highlight" : ""}`}>
